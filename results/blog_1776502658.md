...
| --- | --- | --- | --- | --- | --- | --- |
| 🥇 | `single_step` | 100.0% | 0.588 | 14517 | 440 | 0.0% |
| 🥈 | `tool_using` | 100.0% | 0.376 | 4993 | 968 | 0.0% |
| 🥉 | `routing` | 100.0% | 0.500 | 13138 | 1126 | 2.0% |
| 4 | `parallel` | 100.0% | 0.448 | 16699 | 2701 | 29.3% |
| 5 | `evaluator_optimizer` | 100.0% | 0.776 | 33386 | 4378 | 0.0% |
| 6 | `orchestrator_workers` | 72.0% | 0.539 | 12132 | 966 | 3.2% |
| 7 | `manager_agent` | 48.0% | 0.442 | 11944 | 1108 | 2.4% |
| 8 | `chain` | 36.0% | 0.478 | 8027 | 860 | 13.0% |
| 9 | `human_in_loop` | 24.0% | 0.383 | 8758 | 1038 | 16.7% |
| 10 | `multi_agent_handoff` | 8.0% | 0.400 | 8541 | 1283 | 1.0% |
...
**2. `tool_using` was the fastest workflow** (4993 ms avg latency).  
Single-pass patterns without multi-agent coordination have a natural latency advantage.

**3. `single_step` consumed the fewest tokens on average** (440 tokens).  
Routing and chain patterns avoid redundant LLM calls by design.

**4. `evaluator_optimizer` produced the highest-quality answers** (quality score 0.776).  
