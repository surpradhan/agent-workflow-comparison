...
| --- | --- | --- | --- | --- | --- | --- |
| 🥇 | `single_step` | 100.0% | 0.572 | 7047 | 431 | 0.0% |
| 🥈 | `tool_using` | 100.0% | 0.412 | 4072 | 897 | 0.0% |
| 🥉 | `routing` | 100.0% | 0.356 | 11185 | 1021 | 4.0% |
| 4 | `parallel` | 100.0% | 0.552 | 11294 | 1330 | 31.0% |
| 5 | `evaluator_optimizer` | 100.0% | 0.764 | 35135 | 4554 | 0.0% |
| 6 | `manager_agent` | 72.0% | 0.278 | 14599 | 1359 | 1.5% |
| 7 | `orchestrator_workers` | 68.0% | 0.506 | 12432 | 1197 | 9.3% |
| 8 | `chain` | 48.0% | 0.408 | 11867 | 1687 | 11.8% |
| 9 | `human_in_loop` | 24.0% | 0.467 | 8422 | 972 | 14.3% |
| 10 | `multi_agent_handoff` | 4.0% | 0.900 | 7989 | 1445 | 4.0% |
...
**2. `tool_using` was the fastest workflow** (4072 ms avg latency).  
Single-pass patterns without multi-agent coordination have a natural latency advantage.

**3. `single_step` consumed the fewest tokens on average** (431 tokens).  
Routing and chain patterns avoid redundant LLM calls by design.

**4. `multi_agent_handoff` produced the highest-quality answers** (quality score 0.900).  
