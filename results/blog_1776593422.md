...
| --- | --- | --- | --- | --- | --- | --- |
| 🥇 | `single_step` | 100.0% | 0.740 | 18023 | 454 | 0.0% |
| 🥈 | `tool_using` | 100.0% | 0.532 | 12321 | 996 | 37.0% |
| 🥉 | `routing` | 100.0% | 0.368 | 21867 | 843 | 6.2% |
| 4 | `parallel` | 100.0% | 0.628 | 31281 | 1598 | 59.3% |
| 5 | `evaluator_optimizer` | 100.0% | 0.756 | 55848 | 3270 | 40.0% |
| 6 | `multi_agent_handoff` | 88.0% | 0.809 | 50450 | 3226 | 84.2% |
| 7 | `manager_agent` | 80.0% | 0.495 | 33900 | 1338 | 0.0% |
| 8 | `orchestrator_workers` | 64.0% | 0.637 | 23040 | 776 | 0.0% |
| 9 | `chain` | 48.0% | 0.750 | 22233 | 941 | 14.0% |
| 10 | `human_in_loop` | 40.0% | 0.710 | 30059 | 1596 | 14.6% |
...
**2. `tool_using` was the fastest workflow** (12321 ms avg latency).  
Single-pass patterns without multi-agent coordination have a natural latency advantage.

**3. `single_step` consumed the fewest tokens on average** (454 tokens).  
Routing and chain patterns avoid redundant LLM calls by design.

**4. `multi_agent_handoff` produced the highest-quality answers** (quality score 0.809).  
